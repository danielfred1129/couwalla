...
- (UIView *)createContainerView
{
    ...
    gradient.colors = [NSArray arrayWithObjects:
                       (id)[[UIColor colorWithWhite:0.0 alpha:.5] CGColor],
                       (id)[[UIColor colorWithWhite:0.0 alpha:.5] CGColor],
                       (id)[[UIColor colorWithWhite:0.0 alpha:.5] CGColor],
                       nil];
    ...
    dialogContainer.layer.borderColor = [[UIColor colorWithWhite:0.0 alpha:.5] CGColor];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++)
    {
        ...
        {
            [closeButton setFrame:CGRectMake(60, container.bounds.size.height - buttonHeight, buttonWidth-120, buttonHeight-20)];
        }
        else
        {
        ...
        [closeButton setBackgroundColor:[UIColor appGreenColor]];
