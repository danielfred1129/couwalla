         ...
         completion:(PXAlertViewCompletionBlock)completion
{
    ...
    if (self) {
        ...
        _alertView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"popup_BG_top"]];
...
//        {
//            NSRange rangeTermsAndConditions = [string.string rangeOfString:[[message componentsSeparatedByString:@" "]objectAtIndex:2] options:NSRegularExpressionCaseInsensitive];
//            NSDictionary *attribute =
//            [NSDictionary dictionaryWithObjectsAndKeys:
//             [UIColor redColor],NSForegroundColorAttributeName,
//             nil];
//            
//            [string addAttributes:attribute range:rangeTermsAndConditions];
//        }
//        
//        _messageLabel.attributedText = string;
        ...
        if(_messageLabel.frame.size.height>300)
        {
            UITextView *tv=[[UITextView alloc]initWithFrame:CGRectMake(self.messageLabel.frame.origin.x, self.messageLabel.frame.origin.y, self.messageLabel.frame.size.width,200)];
            tv.text=_messageLabel.text;
            tv.textAlignment = NSTextAlignmentCenter;
            tv.font = [UIFont systemFontOfSize:15];
            [tv setBackgroundColor:[UIColor clearColor]];
            [_alertView addSubview:tv];
            
            
            lineLayer.frame = CGRectMake(0, tv.frame.origin.y + tv.frame.size.height + AlertViewVerticalElementSpace, AlertViewWidth, AlertViewLineLayerWidth);
        }
        else
        {
...
- (UIButton *)genericButton
{
    ...
    [button setTitleColor:[UIColor appGreenColor] forState:UIControlStateNormal];
