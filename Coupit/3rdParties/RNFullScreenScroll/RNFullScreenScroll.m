...
-(void)expand:(BOOL)animated
{
    ...
    if (_shouldHideNavigationBarOnScroll && self.isNavigationBarExisting)
    {
        ...
        if (self.delegateRNTableView != nil && [self.delegateRNTableView respondsToSelector:@selector(hiddenHeaderFooter)])
        {
            [self.delegateRNTableView hiddenHeaderFooter];
        }
    }
...
-(void)contract:(BOOL)animated
{
    ...
    if (_shouldHideNavigationBarOnScroll && !self.isNavigationBarExisting)
    {
        [self.navigationController setNavigationBarHidden:NO
                                                 animated:NO];
        if (self.delegateRNTableView != nil && [self.delegateRNTableView respondsToSelector:@selector(showHeaderFooter)])
        {
            [self.delegateRNTableView showHeaderFooter];
        }
    }
