...
- (id)init
{
    ...
    {
//---------------------------------------
    //    UIColor *color = [UIColor colorWithRed:188 green:67 blue:38 alpha:1.0];
        self.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"search_bg.jpg"]];
...
//    CGFloat R1 = 0.040, G1 = 0.040, B1 = 0.040;
  //  [KxMenu setTintColor:[UIColor colorWithRed:188.0 green:67.0 blue:38.0 alpha:1.0]];
...
//    
////-------------------- I change here for arrow hidden
//    
//    if (_arrowDirection == KxMenuViewArrowDirectionUp)
//    {
//        
