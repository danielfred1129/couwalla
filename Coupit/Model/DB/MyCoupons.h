...
@interface MyCoupons : NSManagedObject
...
@property (nonatomic, retain) NSNumber * mRedeeemSelected;
...
@property (nonatomic, retain) NSDate * mCouponExpireDate;
@property (nonatomic, retain) NSNumber * mRedeemStatus;
@property (nonatomic, retain) NSNumber * mValidity;
