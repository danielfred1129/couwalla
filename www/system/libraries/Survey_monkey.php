...
class Survey_monkey {
     ...
     * @access protected
     */
	protected $_apiKey = 'kjbjfhtsqey9npwd3kq7djch';
   
    /**
     * @var string API access token
     * @access protected
     */
	protected $_accessToken = 'UFHR1aBDl2QjFoOzyDhoj91aM1Q3Atp-HtOvcI8kBk.HIBEdrGLtGKLnbSmHGcE-W1gRHlpGDjjzfvEGvP5aYBSeJFxrC85U1KiJOhE4-68=';
     ...
     */
	public function __construct($params = array(), $options = array(), $connectionOptions = array()) {
	//print_r($params);
		$apiKey = $params['key'];
	...
	protected function run($method, $params = array()){
        ...
        curl_setopt($this->conn, CURLOPT_CAINFO , $caCertPath);
