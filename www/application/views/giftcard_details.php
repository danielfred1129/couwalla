    ...
    <div class="row-fluid">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">Gift Card Details</div>
                <!--<div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <h3></h3>
                <form  class="form-horizontal" name="giftcard"  id="giftcard" action="<?php echo site_url(); ?>admin/edit_giftcard" method="post" enctype="multipart/form-data">
                    ...
                    <?php foreach ($cards as $card) { ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="card_name" value="<?php echo $card['card_name']; ?>"  class="span6 m-wrap" readonly/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Rewards Description</label>
                            <div class="controls">
                                <input type="text" name="description" value="<?php echo $card['description']; ?>"  class="span6 m-wrap" readonly/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="textarea" name="reward_points" value="<?php echo $card['reward_points']; ?>" class="span6 m-wrap" readonly />
                            </div>
                        </div>
                        <div class="control-group">
