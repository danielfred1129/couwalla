        ...
        <form name="display_users" method="post" action="<?php echo site_url(); ?>/admin/delete_user">
            <div class="portlet box light-grey">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-group"></i>Manage Users</div>
                    <!--<div class="tools">
...
<!--                            <a href="<?php echo site_url('admin/add_user'); ?>" class="btn green">Add User</a>-->
                        </div>
                        <div class="btn-group">
...
<!--                                                <th>User Name</th>-->
                        ...
                        <tbody>
                            <?php foreach ($result as $r) { ?>
                                <tr class="odd gradeX">
                                    <td><input type="checkbox" name="user_id[]" class="users" class="checkboxes" value="<?php echo $r['id']; ?>" /></td>
    <!--                                                    <td><a href="<?php echo site_url(); ?>/admin/show_user_profile?id='<?php echo $r['id']; ?>'"><?php echo $r['username']; ?></a></td>-->
                                    <td class="hidden-480"><a href="<?php echo site_url(); ?>/admin/show_user_profile?id=<?php echo $r['id']; ?>"><?php echo $r['firstname']; ?></a></td>
                                    <td class="hidden-480"><?php echo $r['lastname']; ?></td>
                                    <td class="center hidden-480"><?php echo $r['email']; ?></td>
                                    <td class="center hidden-480"><?php echo $r['dob']; ?></td>
        ...
        <script>
            $("#delete").click(function(){
                ...
                if(cat_id == ""){
                    //alert(cat_id);
                    $("span.err").text("Please select Atleast One User");
                    return false;
                }else{
