                        ...
                        <tbody>
                            ...
                            <?php foreach ($result as $r) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="<?php echo site_url(); ?>/admin/show_giftcard_details?id='<?php echo $r['id']; ?>'"><?php echo $r['name']; ?></a></td>
                                    <td class="hidden-480"><?php echo $r['description']; ?></td>
                                    <td class="center hidden-480"><?php echo $r['validfrom']; ?></td>
                                    <td class="center hidden-480"><?php echo $r['validtill']; ?></td>
                                    <td ><span ><?php echo $r['quantity']; ?></span></td>
                                    <td ><span ><?php echo $r['points']; ?></span></td
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
