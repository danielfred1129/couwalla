				       ...
				       <div class="row-fluid">
						...
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<h3></h3>
								<form  class="form-horizontal" name="adduserform"  id="adduserform" action="<?php echo site_url(); ?>/admin/update_notification" method="post">
								...
								<!--<form  class="form-horizontal"  id="form_sample_2" action="#" method="post">-->
									...
									<div class="alert alert-success hide">
									    ...
									    <input type="hidden" name="id" value="<?php echo $res['id']; ?>" class="span6 m-wrap" readonly/>
                                  
									<div class="control-group">
										<label class="control-label">Notification Name<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="notification_name" value="<?php echo $res['notification_name'];?>" class="span6 m-wrap"/>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="notificationtext"  value="<?php echo $res['notificationtext'];?>" class="span6 m-wrap"/>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="notifyon"  value="<?php echo $res['notifyon'];?>" class="span6 m-wrap"/>
										</div>
									</div>
									 ...
									 <div class="control-group">
										...
										<div class="controls">
											<input type="text" name="launch_date" value="<?php echo $res['launch_date'];?>" class="span6 m-wrap"/>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="launch_time" value="<?php echo $res['launch_time'];?>" class="span6 m-wrap"/>
										</div>
									</div>
