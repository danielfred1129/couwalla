				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">Coupons Detailed Report</a></li>
				       ...
				       <div class="row-fluid">
						...
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption">Get Coupons Detailed Report</div>
								<!--<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<h3></h3>
								<form  class="form-horizontal" name="adduserform"  id="adduserform" action="<?php echo site_url(); ?>/admin/display_coupon_detailed_report" method="post">
