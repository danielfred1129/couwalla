    ...
    <div class="portlet box green">
        ...
        <div class="portlet-body form">
            ...
            <form  class="form-horizontal" name="adduserform"  id="adduserform" action="<?php echo site_url(); ?>admin/update_coupons" method="post" enctype="multipart/form-data">
                ...
                <?php $cat_id = explode(",", $coupons->category);  //print_r($cat_id); exit; ?>
                <div class="row-fluid">
                    <div class="span6 ">
                            ...
                            <div class="controls">
                                ...
                                <select class="span12 m-wrap" name="client" id="client">
                                    <?php foreach ($customer as $customer1) { ?>
                                        <option value="<?php echo $customer1['id']; ?>" <?php if($customer1['id'] == $coupons->customer_name){ echo "selected=selected"; } ?> > <?php echo $customer1['companyname']; ?> </option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="span6 ">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select class="span12 m-wrap" name="codetype" readonly id="codetype" >
...
<!--                                <select class="span12 m-wrap" name="store_list" id="store_list">
                                ...
                                <div class="multiselect">
                                    <?php foreach ($store as $store1) { ?>
                                        <label><input type="checkbox" checked="checked" class="store_list" name="store_list[]" value="<?php echo $store1['id']; ?>" /><?php echo $store1['storename']; ?></label>
                                    <?php } ?>
                    ...
                    <div class="span6 ">
                        <div class="control-group" id="couponcode" style="display:block;">
                            ...
                            <div class="controls">
                                <input type="text" name="coupon_code" readonly value="<?php echo $coupons->couponcode; ?>" id="coupon_code" value="" class="span12 m-wrap"/>
                ...
                <div class="row-fluid">
                    <div class="span6 ">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="coupon_name" value="<?php echo $coupons->name; ?>" id="coupon_name" data-required="1" class="span12 m-wrap"/>
                            </div>
                        </div>
                    </div>
                    <!--/span-->
                    <div class="span6 ">
                        <div class="control-group" id="bar_code" style="display:block;">
                            ...
                            <div class="controls">
                                <select class="span12 m-wrap" name="barcode_type" readonly id="barcode_type" >
                ...
                <div class="row-fluid">
                    <div class="span6 ">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="promotext_short" value="<?php echo $coupons->promo_text_short; ?>" id="promotext_short" data-required="1" class="span12 m-wrap"/>
                            </div>
                        </div>
                    </div>
                    <!--/span-->
                    <div class="span6 ">
                        <div class="control-group" id="bar_code_text" style="display:block;">
                            ...
                            <div class="controls" id="newlink_barcode">
                                <input type="text" name="barcode_text" readonly id="barcode_text" data-required="1" value="<?php echo $coupons->barcodedata; ?>" class="span12 m-wrap"/>
                                <div id="newlinktpl_barcode" style="display:none">  
                                    <div class="feed">  
                ...
                <div class="row-fluid">
                    <div class="span6 ">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea  name="coupon_description" id="coupon_description" class="span12 m-wrap"><?php echo $coupons->coupon_description; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <!--/span-->
                    ...
                    <div class="span6 ">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <textarea  name="terms_conditions" id="terms_conditions" class="span12 m-wrap"><?php echo $coupons->terms_conditions; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <!--/span-->
                    ...
                    <div class="span6 ">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="checkbox"  name="whats_hot"  value="1" <?php if ($coupons->whats_hot == 1) { echo "checked=checked"; }?> /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox"  name="national_coupon"  value="1" <?php if ($coupons->national_coupon == 1) { echo "checked=checked"; }?> />
                ...
                <div class="row-fluid">
                    <div class="span6 ">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="no_of_downloads" id="no_of_downloads" value="<?php echo $coupons->downloads; ?>"  class="span3 m-wrap"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Quantity Issued<span class="required">*</span></label>
                            <div class="controls">
                                <input type="text" name="quantity" data-required="1" value="<?php echo $coupons->quantity; ?>" class="span3 m-wrap"/>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="reward_points" id="reward_points" value="<?php echo $coupons->reward_points; ?>" data-required="1" class="span3 m-wrap"/>
                            </div>
                        </div>
                    </div>
                    <!--/span-->
...
<!--                                <select class="span12 m-wrap" name="sub_category[]" multiple="multiple" >
  ...
  <!--                                    <label><input type="checkbox" name="category[]"  value="0" />Select Category</label>-->
                                    <?php foreach ($subcategory as $sub_cat) { ?>
                                        <label><input type="checkbox" class="category" name="sub_category[]"  id="category<?php echo $sub_cat['id']; ?>" value="<?php echo $sub_cat['id']; ?>" /><?php echo $sub_cat['category_name']; ?></label>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row-fluid">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend" >
                                    <span class="add-on"><i class="icon-calendar"></i></span><input type="text" value="<?php echo $coupons->launch_date . " to " . $coupons->expiry_date; ?>" class="m-wrap date-range" name="coupon_date"  />
                                </div>
                    ...
                    <div class="span6 ">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="legal_url" class="span12 m-wrap" value="<?php echo $coupons->legal_url; ?>" />
                            </div>
                        </div>
                    </div>
                    <!--/span-->
                    ...
                    <div class="span6 ">
                        <div class="control-group">
                            ...
                            <div class="controls" id="newlink_keyword">
                                ...
                                <!--<div id="newlink" > --> 
                                <input type="text" name="keywords[]" value="<?php echo $coupons->keywords; ?>" class="span12 m-wrap" />
                ...
                <div class="form-actions">
                    <button type="submit" class="btn green" id="add_btn">Update</button>
                </div>
