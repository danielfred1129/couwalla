				       ...
				       <div class="row-fluid">
						...
						<div class="portlet box green">
							<div class="portlet-title">
								<div class="caption">Add Campaign</div>
								<!--<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<h3></h3>
								<form  class="form-horizontal" name="adduserform"  id="adduserform" action="<?php echo site_url(); ?>/admin/add_new_campaign" method="post">
								...
								<!--<form  class="form-horizontal"  id="form_sample_2" action="#" method="post">-->
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="campaignname" data-required="1" class="span6 m-wrap"/>
										</div>
									</div>
									...
									<div class="control-group">
									 ...
									 <div class="control-group">
										...
										<div class="controls">
											<input type="text" name="starttime" data-required="1" class="span6 m-wrap"/>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="endtime" data-required="1" class="span6 m-wrap"/>
										</div>
									</div>
									...
									<div class="control-group">
										<label class="control-label">Notes</span></label>
										<div class="controls">
										    <textarea  name="notes" class="span6 m-wrap"></textarea>
										</div>
									</div>
